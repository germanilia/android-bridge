...
- [ ] Mobile Second Brain UX repair — implementation, unit tests, debug/release builds, signed APK verification, and signer-compatible in-place Pixel 9a deployment complete for `0.1.1`. Back navigation, dirty-edit protection, single-flight refresh, search refresh, and note loading were repaired. Commit/push, rolling CI, stable `v0.1.1` publication, and unlocked-device visual verification remain. Summary: `aidlc-docs/construction/mobile-second-brain-ux-repair/code/summary.md`.
